                        ...
                        <div className="relative  w-96 rounded-3xl my-6 mx-auto max-w-sm">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white">
                                ...
                                <div className="relative p-6 flex-auto">
                                   ...
                                   {step===1 && <> <input className="w-full h-11 -mt-1 text-left text-lg px-4 border border-gray-300 focus:outline-none rounded-md focus:border-8 focus:border-green-800 "
                                        type="tel" placeholder="Gmail" value={email} onChange={event => setEmail(event.target.value)}
                                    />
                                    ...
                                    {step===2 && <input className="w-full h-11 -mt-1 text-left text-lg px-4 border border-gray-300 focus:outline-none rounded-md focus:border-8 focus:border-green-800 "
                                    ...
                                    <Link
                                      onClick={handleLogIn}
                                        ...
                                        type="button" disabled={!input || !password}
                                    >
                                        Log In
                                    </Link>
                                ...
                                <div className="flex items-center justify-start mx-6 py-3 rounded-3xl">
                                    <p onClick={()=>{setShowSignUp(true);setShowModal(false)}} className="mb-2 font-light text-gray-800 text-lg leading-relaxed rounded-3xl">
                                        New to Frieght Forward? <span className="text-pink-700">Create account</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative  w-full rounded-3xl my-6 mx-auto max-w-sm">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white">
                                        ...
                                        <div className="flex items-start">
                                            <div className="flex items-center h-5">
                                                ...
                                                <label className="font-normal text-xs m-2 text-gray-500">
                                                    I agree to frieght forward <span className="text-pink-500 font-medium"> Terms of Service, Privacy Policy</span> and
                                ...
                                <div className="flex items-center justify-start mx-6 mb-2 rounded-3xl">
                                    <p onClick={()=>{setShowSignUp(false);setShowModal(true)}} className="mb-2 text-gray-800 text-lg leading-relaxed rounded-3xl">
